...
const CurriculumAddModal: React.FC<Props> = ({ open, onClose, onSuccess }) => {
  ...
  const validate = () => {
    ...
    if (!formData.businessName.trim()) newErrors.businessName = "사업명을 입력해주세요.";
        ...
        <Grid container spacing={3}>
          ...
          <Grid size={{ xs: 6 }}>
            <TextField 
              ...
              placeholder="숫자 입력"
              InputProps={{ endAdornment: <InputAdornment position="end">기</InputAdornment> }}
            />
          </Grid>
          ...
          <Grid size={{ xs: 6 }}>
            <TextField 
              ...
              placeholder="예: 301호"
              InputProps={{ startAdornment: <InputAdornment position="start"><MeetingRoomIcon fontSize="small" /></InputAdornment> }}
            />
          </Grid>
