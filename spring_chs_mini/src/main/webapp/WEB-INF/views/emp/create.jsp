			...
			<div class="card">
				<div class="card-body">
					...
					<div class="basic-form">
						...
						요청방식 : post
						 -->
						<form id="frm" action="/emp/createPost" method="post">
							...
							<div class="form-group">
								<input type="text" class="form-control input-default"
									id="empAddr" name="empAddr" placeholder="주소">
							</div>
							<div class="form-group">
								<input type="text" class="form-control input-default"
									id="empPhone" name="empPhone" placeholder="연락처">
							</div>
							<div class="form-group">
								<input type="number" class="form-control input-default"
									id="sal" name="sal" placeholder="월급">
							</div>
